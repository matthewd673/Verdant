...
namespace Verdant.Physics
{
    internal class CollisionData
    {
        ...
        {
            Debugging.Log.WriteLine("CollisionResolution()");
            // closing velocity
            Vec2 colArm1 = cp - a.Components[0].Position;
            Vec2 rotVel1 = new(-a.AngleSpeed * colArm1.Y, a.AngleSpeed * colArm1.X);
            Vec2 closVel1 = a.Velocity + rotVel1;

            Vec2 colArm2 = cp - b.Components[0].Position;
            Vec2 rotVel2 = new(-b.AngleSpeed * colArm2.Y, b.AngleSpeed * colArm2.X);
