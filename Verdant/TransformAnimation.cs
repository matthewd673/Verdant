...
public class TransformAnimation
{
    ...
    public TransformBlendMode BlendMode { get; private set; }
    ...
    public TransformAnimation(Transform from, Transform to, float duration)
    {
        From = from;
        To = to;
    ...
    public TransformAnimation(Transform from, Transform to, float duration, TimingFunction timingFunction)
    {
        From = from;
        To = to;
        BlendMode = From.BlendMode; // you can't mix them
    ...
    private TransformAnimation(Transform from, Transform to, float duration, TimingFunction timingFunction, Transform diff)
    {
        From = from;
        To = to;
